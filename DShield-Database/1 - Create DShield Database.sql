...
--  Creates the base server audit object
-- =============================================

CREATE SERVER AUDIT DShield_Database_Server_Audit
    TO FILE (FILEPATH = 'C:\DShield Database Audits\');
GO

-- =============================================
-- DShield Database Server Audit
--  Enables the base server audit object
-- =============================================
ALTER SERVER AUDIT DShield_Database_Server_Audit WITH (STATE = ON);
GO

CREATE SERVER AUDIT SPECIFICATION Failed_Login_Audit_Specification  
FOR SERVER AUDIT DShield_Database_Server_Audit  
    ADD (FAILED_LOGIN_GROUP);  
GO  

CREATE SERVER AUDIT SPECIFICATION App_Role_Password_Change_Audit_Specification  
FOR SERVER AUDIT DShield_Database_Server_Audit  
    ADD (APPLICATION_ROLE_CHANGE_PASSWORD_GROUP);  
GO  

CREATE SERVER AUDIT SPECIFICATION Permissions_Change_Audit_Specification  
FOR SERVER AUDIT DShield_Database_Server_Audit  
    ADD (DATABASE_PERMISSION_CHANGE_GROUP);  
GO  

CREATE SERVER AUDIT SPECIFICATION Principal_Change_Audit_Specification  
FOR SERVER AUDIT DShield_Database_Server_Audit  
    ADD (DATABASE_PRINCIPAL_CHANGE_GROUP);  
GO  

CREATE SERVER AUDIT SPECIFICATION Role_Membership_Audit_Specification  
FOR SERVER AUDIT DShield_Database_Server_Audit  
    ADD (DATABASE_ROLE_MEMBER_CHANGE_GROUP);  
GO  

CREATE SERVER AUDIT SPECIFICATION Server_Principal_Audit_Specification  
FOR SERVER AUDIT DShield_Database_Server_Audit  
    ADD (SERVER_PRINCIPAL_CHANGE_GROUP);  
GO  

CREATE SERVER AUDIT SPECIFICATION New_User_Audit_Specification  
FOR SERVER AUDIT DShield_Database_Server_Audit  
